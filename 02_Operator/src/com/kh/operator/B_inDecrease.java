...
public class B_inDecrease {
	...
	public void method1() {
		...
		System.out.println("2회 수행 후 결과 : " + ++num); // 현재 num=11 이 담겨있음. 따라서 12가 출력됨.
		...
		System.out.println("1회 수행 후 결과 : "+ num2++); //10 출력 후 1 증가 -> 즉, 출력당시에는 10이 출력되고, 출력처리가 끝나고나서 11로 증감처리 됨.
		System.out.println("2회 수행 후 결과 : "+ num2++); //11 출력 후 1 증가 -> num2 = 12
		System.out.println("3회 수행 후 결과 : "+ num2++); //12 출력 후 1 증가 -> num2 = 13
	...
	public void method2() {
		...
		System.out.println("최종 num ? : "+ num); // 출력시 : 20 , num : 20
	...
	public void method4() {
		...
		System.out.println(a++); //출력시:10 , a:11
		System.out.println((++a) + (b++)); // 출력시 a:12 b:20 , a:12 b : 21 =>32
		System.out.println((a++) + (--b) + (--c)); //출력시 a:12 b:20 c:29 , a:13 b:20 c:29 => 61
