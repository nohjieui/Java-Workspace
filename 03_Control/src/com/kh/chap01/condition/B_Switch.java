...
public class B_Switch {
	 ...
	 *                    // 위의 값1, 값2, 값n... 앞으로 동등비교를 할 대상과 하나도 일치하지 않다면, default 내의 실행할 코드가 실현된다.
	 * }
	 * 
	 * switch는 자주사용되진 않지만, 사용하는 경우에는 정말 정밀하게 동일한 연산결과가 수행되어야 하는 경우
	 * ex) 키보드 입력, 마우스 입력 등
	 * 
	 */
...
//		}
	...
	public void method2() {
		...
		// 각 과일마다의 가격을 출력(사과 1000월, 바나나 2000원, 복숭아 5000월)
		// 잘못된 "과일 입력시 저희 가게에서 판매하는 과일이 아닙니다." 
		Scanner sc = new Scanner(System.in);
		
		System.out.print("구매할 과일명(사과, 바나나, 복숭아) : ");
	...
	public void method4() {
		...
		default : System.out.println("해당 달은 반드시 1월~12월까지 입력해야합니다.");
		}
