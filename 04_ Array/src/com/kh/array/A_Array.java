...
public class A_Array {
	...
	public void method1() {
		...
		// [I@28f67ac7 여기서 @기준으로 우측은 참조하고 있는 heap 영역의 주소값
		// [ : 배열을 나타냄
		// I : int 자료형을 의미함.
	...
	public void method2() {
		 ...
		 * 5칸짜리 방이 만들어진 후에 각 방에 기본값으로(int 0으로) 데이터가 초기화 되고, 주소값이 할당됨(0x123)
		 * 마지막으로 대입연산자가 실행되면서 주소값이 arr에 할당이 됨
		 */
		System.out.println("i : " + i);
		System.out.println("arr : " + arr); //[I@71dac704 => 71dac704 는 16진수 형태의 주소값
		System.out.println("arr의 해시코드값 : " + arr.hashCode()); //arr의 주소값을 10진수로 바꾼값
		...
		/*
		 * 기본자로형(boolean, char, byte, short, int, long, float, double)
...
//		}
	...
	public void method4() {
		...
		/*
		 * ArrayIndexOutOfBoundsException 이라는 에러가 남.
		 * => 배열의 인덱스 범위를 벗어남.
		 */
	}
...
//		}
		 ...
		 * => 배열의 크기를 변경하고자한다면 어쩔 수 없이 새로운 배열을 다시 만들어야 함.
		 */
		...
		System.out.println("arr의 해시코드 값 : "+ arr.hashCode());
		/*
		 * 항상 고유한 주소값에 부여, 기존에 생성되었던 주소와 절!대로 겹치지 않는다.
		 * 기존에 참조하고 있던 연결이 끊기고 새로운 곳 참조
		 * 
		 * 연결이 끊어진 기존의 배열은 heap 영역에 둥둥 떠다님
		 * 일정 시간이 지나고서도, 사용이 되지 않으면 "가비지 컬렉터(GC)"가 삭제시켜줌.
		 * (자동 메모리 관리)
		 * => 자바에서 자동메모리 관리 특징. 개발자가 코드에만 신경쓸 수 있게 해줌.
		 */
		
		
		// 현재 연결되어 있는 고리를 끊고자 할 때
	...
	public void method7() {
		...
		// 방법1.
		int[] arr1 = new int[] {1, 2, 3, 4}; //길이 4칸짜리 배열
		
		// 방법2.
		int[] arr2 = {1, 2, 3, 4}; //길이 4칸짜리 배열
		
		// 배열 비교
		System.out.println(arr1 == arr2);
		// arr1 -> arr1의 heap 영역의 "주소값"
		// arr2 -> arr2의 heap 영역의 "주소값"
		// 주소값 == 주소값 : 주소값 간에 동등비교를 수행하기 때문에 false
	...
	public void method10() {
		...
		// 2. char 배열 생성해주기(배열 크기 == 문자열의 길이만틈)
	...
	public void method11() {
		// 1. 사용자에게 배열의 길이 입력 받은 후, 해당 크기 만큼 정수 배열 생성
		Scanner sc = new Scanner(System.in);
		...
		// 3. 반목문 활용해서 0번 인덱스부터 ~마지막 인덱스까지 배열에 담긴값 출력과 동시에,
	...
	public void method12() {
		...
		// 1. 반복문을 활용해서 height 배열의 0번 인덱스부터 마지막 인덱스까지 반복을 진행하면서
		//    사용자로부터 키에 대한 정보(cm)를 입력받아 각 인덱스에 저장.
		for(int i = 0; i < height.length; i++) {
			System.out.print("키를 입력하세요(cm) : ");
			height[i] = sc.nextDouble(); // 155.3, 160.5, 180.4
		}
...
//			System.out.printf("height[%d] : %.1f \n", i, height[i]);
		...
		// 3. 3명의 키의 총합을 출력하고, 3명 키의 평균도 출력 (단, 소수점 첫째자리까지 출력)
		System.out.printf("3명의 키의 총 합 : %.1f \n", sum);
