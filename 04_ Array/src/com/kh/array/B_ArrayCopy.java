...
public class B_ArrayCopy {
	...
	// 자바에서 제공하는 다양한 메서드를 사용해서 배열을 복사
	public void method3() {
		...
		// System.arraycoppy(원본 배열명, 원본배열의 복사를 시작할 인덱스, 복사본 배열명, 복사본 배열의 복사될 시작 인덱스, 복사할 갯수)
		
		//System.arraycopy(origin, 0, copy, 0, 5); // 1 2 3 4 5 0 0 0 0 0
		//System.arraycopy(origin, 0, copy, 2, 5); // 0 0 1 2 3 4 5 0 0 0 0
	...
	public void method4() {
		// 3. Arrays 클래스에서 제공하는 copyOf 메소드를 이용한 복사 -> import 해야함
		...
		/*
		 * 2. System.arraycopy 메소드 : 몇번 인덱스부터 몇개를 어느 위치의 인덱스에 복사할 것인지 세밀하게 지정가능.
		 * 
		 * 2. Arrays.copyOf 메소드 : 무조건 원본 배열의 0번 인덱스부터 내가 제시한 갯수만큼 복사 진행됨.
	...
	public void method5() {
		...
		System.out.println(Arrays.toString(origin)); //origin 배열 출력 => Arrays 클래스에 있는 toString 메소드 사용할 수 있음
		...
		// clone 메소드 : 배열을 제외한 다른 메소드 사용시에는 얕은 복사가 이루어짐(배열에서만 깊은 복사가 됨)
