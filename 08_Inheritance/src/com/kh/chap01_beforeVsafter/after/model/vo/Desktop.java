...
//		super(); //자동으로 적용되므로 생략가능
	...
	public Desktop(String brand, String pCode, String pName, int price, boolean allInOne) {
		...
		// 해결방법 1. 부모클래스의 필드를 자식까지는 접근가능하도록 접근제한자를 변겅
		//           private -> protected로 변경
//		super.brand = brand;
//		super.pCode = pCode;
//		super.pName = pName;
//		super.price = price;
		// 해결방법 2. 부모클래스에서 접근할 수 있는(public)에서 setter메서드 활용.
...
//		super.setPrice(price);
	...
	public String information() {
		return super.infomartion() + ", allInOne : "+allInOne;
	}
