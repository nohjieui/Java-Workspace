...
public class A_StringPoolTest {
	...
	public void method1() {
		...
		// String클래스의 hashCode()메소드의 경우 주소값이 기반이 아닌 
		// 실제 담긴 문자열 기반으로 해시코드값을 반환하도록 오버라이딩 되어있음
		
		// 정말 주소값을 알고싶을 때 사용하는 메서드 System.identityHashCode(참조번수(레퍼런스변수));
	...
	public void method3() {
		...
		str += "abc"; // str = str + "abc";
		System.out.println(System.identityHashCode(str));
		System.out.println(str); //goodbyeabc
