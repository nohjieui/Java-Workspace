package com.kh.chap03_evnet.view;
	...
	public MainFrame() {
		...
		plusBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				result.setText(value1 + value2+""); // setText는 String타입으로 문자열로 변경해야하기 때문에 "" 추가
			}
		});
		// ActionListner : 인터페이스이기때문에 곧바로 생성 불가.
		// 단, 여기서 생성을하고싶다면 "미완성된 메소드"를 완성시키면서 생성 => 익명 클래스 방식
		
		// minusBtn 클릭시 => 두개의 정수값을 가져온 후 뺄셈연산 결과를 result텍스트 상자에 출력
