...
public class Run {
	 ...
	 * - 모든 프로세스에는 한개 이상의 스레드가 존재하여 작업을 수행함(일꾼)
	 * 
	 * 멀티스레드
...
//		Thread th3 = new Thread(th2);
		...
		Thread th2 = new Thread(new Thread2()); // 위와 같은 코드임
		...
		// 스레드 생성 방법 : 3. 1회용 스레드가 필요할 때(익명클래스)
		// 굳이 클래스만들 필요 없이 1회용으로만 만들고자 할 때 사용.
