	...
	public void clientStart() {
		...
		try {
			...
			if(socket != null) {
				...
				do {
					System.out.print("서버의 보낼 내용 : ");
					str = sc.nextLine();
					
					pw.println(str); // 내가 작성한 문자 내보내기
					...
					String message = br.readLine(); // 서버가 나한테 보내준 데이터를 한줄단위로 출력
